...
gfg: dsa/atlantic-pacific-water-flow
neetcode: pacific-atlantic-water-flow
hellointerview: code/depth-first-search/pacific-atlantic-water-flow
---
...
<MdxImage alt="" src="https://assets.leetcode.com/uploads/2021/06/08/waterflow-grid.jpg" style="width: 400px; height: 400px;" />
```
